...
namespace Aufgabe5 {
    ...
    export let data: HomoVar = {
        "Baeume": [{ text: "Waehle eine Baumart aus", preis: 20, name: "Ahorn" },{ text: "Waehle eine Baumart aus", preis: 20, name: "Kiefer" }, { text: "Waehle eine Baumart aus",preis: 30, name: "Tanne" }, { text: "Waehle eine Baumart aus",preis: 45, name: "Fichte" }],
