...
(function (Aufgabe2) {
    ...
    function main() {
        ...
        /*Das neue div wird dem body angeh�ngt*/
        ...
        /*Die Schleife l�uft solange durch, bis die Anzahl der Handkarten mit der vom User eingegebene Zahl �bereinstimmt*/
        for (let i = 0; i < parseInt(maxHand); i++) {
            ...
            /*Es wird eine zuf�llige Zahl ermittelt, die zwischen 0 und der l�nge des Arrays karten liegt und in der Variable t gespeichert*/
            let t = Math.floor(Math.random() * karten.length);
            /*In das neue div wird der Text, der im Array karten an Stelle t gespeichert ist, geschrieben. Dabei wird der Erste Buchstabe weggelassen, der nur zur Ermittlung der Farbe ben�tigt wird*/
            ...
            /*Es wird eine Zahl ermittelt, die i*200 ist und in der Variable z gespeichert wird, um zu verhindern, dass alle Handkarten an einer Position sind und sich somit �berlagern w�rden*/
            let z = i * 200;
            /*die Position (wie weit die Handkarte links vom Bildschirm einger�ckt ist) der Handkarte wird mit Hilfe der Variable z bestimmt*/
